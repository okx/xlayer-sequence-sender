...
func (_Polygonrollupmanager *PolygonrollupmanagerCaller) ZKGASLIMITBATCH(opts *bind.CallOpts) (uint64, error) {
	var out []interface{}
	err := _Polygonrollupmanager.contract.Call(opts, &out, "ZK_GAS_LIMIT_BATCH")
...
//
// Solidity: function ZK_GAS_LIMIT_BATCH() view returns(uint64)
func (_Polygonrollupmanager *PolygonrollupmanagerSession) ZKGASLIMITBATCH() (uint64, error) {
	return _Polygonrollupmanager.Contract.ZKGASLIMITBATCH(&_Polygonrollupmanager.CallOpts)
}

// ZKGASLIMITBATCH is a free data retrieval call binding the contract method 0x838a2503.
//
// Solidity: function ZK_GAS_LIMIT_BATCH() view returns(uint64)
func (_Polygonrollupmanager *PolygonrollupmanagerCallerSession) ZKGASLIMITBATCH() (uint64, error) {
	return _Polygonrollupmanager.Contract.ZKGASLIMITBATCH(&_Polygonrollupmanager.CallOpts)
}
...
func (_Polygonrollupmanager *PolygonrollupmanagerCaller) AggregateRollupVerifier(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Polygonrollupmanager.contract.Call(opts, &out, "aggregateRollupVerifier")
...
//
// Solidity: function aggregateRollupVerifier() view returns(address)
func (_Polygonrollupmanager *PolygonrollupmanagerSession) AggregateRollupVerifier() (common.Address, error) {
	return _Polygonrollupmanager.Contract.AggregateRollupVerifier(&_Polygonrollupmanager.CallOpts)
}

// AggregateRollupVerifier is a free data retrieval call binding the contract method 0xba988cef.
//
// Solidity: function aggregateRollupVerifier() view returns(address)
func (_Polygonrollupmanager *PolygonrollupmanagerCallerSession) AggregateRollupVerifier() (common.Address, error) {
	return _Polygonrollupmanager.Contract.AggregateRollupVerifier(&_Polygonrollupmanager.CallOpts)
}
...
func (_Polygonrollupmanager *PolygonrollupmanagerCaller) CalculateRewardPerZkGas(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Polygonrollupmanager.contract.Call(opts, &out, "calculateRewardPerZkGas")
...
//
// Solidity: function calculateRewardPerZkGas() view returns(uint256)
func (_Polygonrollupmanager *PolygonrollupmanagerSession) CalculateRewardPerZkGas() (*big.Int, error) {
	return _Polygonrollupmanager.Contract.CalculateRewardPerZkGas(&_Polygonrollupmanager.CallOpts)
}

// CalculateRewardPerZkGas is a free data retrieval call binding the contract method 0x90031d5c.
//
// Solidity: function calculateRewardPerZkGas() view returns(uint256)
func (_Polygonrollupmanager *PolygonrollupmanagerCallerSession) CalculateRewardPerZkGas() (*big.Int, error) {
	return _Polygonrollupmanager.Contract.CalculateRewardPerZkGas(&_Polygonrollupmanager.CallOpts)
}
...
func (_Polygonrollupmanager *PolygonrollupmanagerCaller) GetForcedZkGasPrice(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Polygonrollupmanager.contract.Call(opts, &out, "getForcedZkGasPrice")
...
//
// Solidity: function getForcedZkGasPrice() view returns(uint256)
func (_Polygonrollupmanager *PolygonrollupmanagerSession) GetForcedZkGasPrice() (*big.Int, error) {
	return _Polygonrollupmanager.Contract.GetForcedZkGasPrice(&_Polygonrollupmanager.CallOpts)
}

// GetForcedZkGasPrice is a free data retrieval call binding the contract method 0x02f3fa60.
//
// Solidity: function getForcedZkGasPrice() view returns(uint256)
func (_Polygonrollupmanager *PolygonrollupmanagerCallerSession) GetForcedZkGasPrice() (*big.Int, error) {
	return _Polygonrollupmanager.Contract.GetForcedZkGasPrice(&_Polygonrollupmanager.CallOpts)
}
...
func (_Polygonrollupmanager *PolygonrollupmanagerCaller) GetLastVerifiedSequence(opts *bind.CallOpts, rollupID uint32) (uint64, error) {
	var out []interface{}
	err := _Polygonrollupmanager.contract.Call(opts, &out, "getLastVerifiedSequence", rollupID)
...
//
// Solidity: function getLastVerifiedSequence(uint32 rollupID) view returns(uint64)
func (_Polygonrollupmanager *PolygonrollupmanagerSession) GetLastVerifiedSequence(rollupID uint32) (uint64, error) {
	return _Polygonrollupmanager.Contract.GetLastVerifiedSequence(&_Polygonrollupmanager.CallOpts, rollupID)
}

// GetLastVerifiedSequence is a free data retrieval call binding the contract method 0x0a7eef7a.
//
// Solidity: function getLastVerifiedSequence(uint32 rollupID) view returns(uint64)
func (_Polygonrollupmanager *PolygonrollupmanagerCallerSession) GetLastVerifiedSequence(rollupID uint32) (uint64, error) {
	return _Polygonrollupmanager.Contract.GetLastVerifiedSequence(&_Polygonrollupmanager.CallOpts, rollupID)
}
...
func (_Polygonrollupmanager *PolygonrollupmanagerCaller) GetRollupPendingStateTransitions(opts *bind.CallOpts, rollupID uint32, sequenceNum uint64) (PolygonRollupManagerPendingStateSequenceBased, error) {
	var out []interface{}
	err := _Polygonrollupmanager.contract.Call(opts, &out, "getRollupPendingStateTransitions", rollupID, sequenceNum)
...
//
// Solidity: function getRollupPendingStateTransitions(uint32 rollupID, uint64 sequenceNum) view returns((uint64,uint64,bytes32,bytes32))
func (_Polygonrollupmanager *PolygonrollupmanagerSession) GetRollupPendingStateTransitions(rollupID uint32, sequenceNum uint64) (PolygonRollupManagerPendingStateSequenceBased, error) {
	return _Polygonrollupmanager.Contract.GetRollupPendingStateTransitions(&_Polygonrollupmanager.CallOpts, rollupID, sequenceNum)
}

// GetRollupPendingStateTransitions is a free data retrieval call binding the contract method 0xb99d0ad7.
//
// Solidity: function getRollupPendingStateTransitions(uint32 rollupID, uint64 sequenceNum) view returns((uint64,uint64,bytes32,bytes32))
func (_Polygonrollupmanager *PolygonrollupmanagerCallerSession) GetRollupPendingStateTransitions(rollupID uint32, sequenceNum uint64) (PolygonRollupManagerPendingStateSequenceBased, error) {
	return _Polygonrollupmanager.Contract.GetRollupPendingStateTransitions(&_Polygonrollupmanager.CallOpts, rollupID, sequenceNum)
}
...
func (_Polygonrollupmanager *PolygonrollupmanagerCaller) GetRollupSequencedSequences(opts *bind.CallOpts, rollupID uint32, sequenceNum uint64) (PolygonRollupManagerSequencedData, error) {
	var out []interface{}
	err := _Polygonrollupmanager.contract.Call(opts, &out, "getRollupSequencedSequences", rollupID, sequenceNum)
...
//
// Solidity: function getRollupSequencedSequences(uint32 rollupID, uint64 sequenceNum) view returns((bytes32,uint64,uint64,uint128))
func (_Polygonrollupmanager *PolygonrollupmanagerSession) GetRollupSequencedSequences(rollupID uint32, sequenceNum uint64) (PolygonRollupManagerSequencedData, error) {
	return _Polygonrollupmanager.Contract.GetRollupSequencedSequences(&_Polygonrollupmanager.CallOpts, rollupID, sequenceNum)
}

// GetRollupSequencedSequences is a free data retrieval call binding the contract method 0xa9a77031.
//
// Solidity: function getRollupSequencedSequences(uint32 rollupID, uint64 sequenceNum) view returns((bytes32,uint64,uint64,uint128))
func (_Polygonrollupmanager *PolygonrollupmanagerCallerSession) GetRollupSequencedSequences(rollupID uint32, sequenceNum uint64) (PolygonRollupManagerSequencedData, error) {
	return _Polygonrollupmanager.Contract.GetRollupSequencedSequences(&_Polygonrollupmanager.CallOpts, rollupID, sequenceNum)
}
...
func (_Polygonrollupmanager *PolygonrollupmanagerCaller) GetRollupsequenceNumToStateRoot(opts *bind.CallOpts, rollupID uint32, sequenceNum uint64) ([32]byte, error) {
	var out []interface{}
	err := _Polygonrollupmanager.contract.Call(opts, &out, "getRollupsequenceNumToStateRoot", rollupID, sequenceNum)
...
//
// Solidity: function getRollupsequenceNumToStateRoot(uint32 rollupID, uint64 sequenceNum) view returns(bytes32)
func (_Polygonrollupmanager *PolygonrollupmanagerSession) GetRollupsequenceNumToStateRoot(rollupID uint32, sequenceNum uint64) ([32]byte, error) {
	return _Polygonrollupmanager.Contract.GetRollupsequenceNumToStateRoot(&_Polygonrollupmanager.CallOpts, rollupID, sequenceNum)
}

// GetRollupsequenceNumToStateRoot is a free data retrieval call binding the contract method 0xeb142b40.
//
// Solidity: function getRollupsequenceNumToStateRoot(uint32 rollupID, uint64 sequenceNum) view returns(bytes32)
func (_Polygonrollupmanager *PolygonrollupmanagerCallerSession) GetRollupsequenceNumToStateRoot(rollupID uint32, sequenceNum uint64) ([32]byte, error) {
	return _Polygonrollupmanager.Contract.GetRollupsequenceNumToStateRoot(&_Polygonrollupmanager.CallOpts, rollupID, sequenceNum)
}
...
func (_Polygonrollupmanager *PolygonrollupmanagerCaller) GetZkGasPrice(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Polygonrollupmanager.contract.Call(opts, &out, "getZkGasPrice")
...
//
// Solidity: function getZkGasPrice() view returns(uint256)
func (_Polygonrollupmanager *PolygonrollupmanagerSession) GetZkGasPrice() (*big.Int, error) {
	return _Polygonrollupmanager.Contract.GetZkGasPrice(&_Polygonrollupmanager.CallOpts)
}

// GetZkGasPrice is a free data retrieval call binding the contract method 0xf4174a17.
//
// Solidity: function getZkGasPrice() view returns(uint256)
func (_Polygonrollupmanager *PolygonrollupmanagerCallerSession) GetZkGasPrice() (*big.Int, error) {
	return _Polygonrollupmanager.Contract.GetZkGasPrice(&_Polygonrollupmanager.CallOpts)
}
...
func (_Polygonrollupmanager *PolygonrollupmanagerCaller) MultiplierZkGasPrice(opts *bind.CallOpts) (uint16, error) {
	var out []interface{}
	err := _Polygonrollupmanager.contract.Call(opts, &out, "multiplierZkGasPrice")
...
//
// Solidity: function multiplierZkGasPrice() view returns(uint16)
func (_Polygonrollupmanager *PolygonrollupmanagerSession) MultiplierZkGasPrice() (uint16, error) {
	return _Polygonrollupmanager.Contract.MultiplierZkGasPrice(&_Polygonrollupmanager.CallOpts)
}

// MultiplierZkGasPrice is a free data retrieval call binding the contract method 0x9ff22cb5.
//
// Solidity: function multiplierZkGasPrice() view returns(uint16)
func (_Polygonrollupmanager *PolygonrollupmanagerCallerSession) MultiplierZkGasPrice() (uint16, error) {
	return _Polygonrollupmanager.Contract.MultiplierZkGasPrice(&_Polygonrollupmanager.CallOpts)
}
...
func (_Polygonrollupmanager *PolygonrollupmanagerCaller) TotalVerifiedZkGasLimit(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Polygonrollupmanager.contract.Call(opts, &out, "totalVerifiedZkGasLimit")
...
//
// Solidity: function totalVerifiedZkGasLimit() view returns(uint128)
func (_Polygonrollupmanager *PolygonrollupmanagerSession) TotalVerifiedZkGasLimit() (*big.Int, error) {
	return _Polygonrollupmanager.Contract.TotalVerifiedZkGasLimit(&_Polygonrollupmanager.CallOpts)
}

// TotalVerifiedZkGasLimit is a free data retrieval call binding the contract method 0x27696c5e.
//
// Solidity: function totalVerifiedZkGasLimit() view returns(uint128)
func (_Polygonrollupmanager *PolygonrollupmanagerCallerSession) TotalVerifiedZkGasLimit() (*big.Int, error) {
	return _Polygonrollupmanager.Contract.TotalVerifiedZkGasLimit(&_Polygonrollupmanager.CallOpts)
}
...
func (_Polygonrollupmanager *PolygonrollupmanagerCaller) TotalZkGasLimit(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Polygonrollupmanager.contract.Call(opts, &out, "totalZkGasLimit")
...
//
// Solidity: function totalZkGasLimit() view returns(uint128)
func (_Polygonrollupmanager *PolygonrollupmanagerSession) TotalZkGasLimit() (*big.Int, error) {
	return _Polygonrollupmanager.Contract.TotalZkGasLimit(&_Polygonrollupmanager.CallOpts)
}

// TotalZkGasLimit is a free data retrieval call binding the contract method 0x6c6be9eb.
//
// Solidity: function totalZkGasLimit() view returns(uint128)
func (_Polygonrollupmanager *PolygonrollupmanagerCallerSession) TotalZkGasLimit() (*big.Int, error) {
	return _Polygonrollupmanager.Contract.TotalZkGasLimit(&_Polygonrollupmanager.CallOpts)
}
...
func (_Polygonrollupmanager *PolygonrollupmanagerCaller) VerifySequenceTimeTarget(opts *bind.CallOpts) (uint64, error) {
	var out []interface{}
	err := _Polygonrollupmanager.contract.Call(opts, &out, "verifySequenceTimeTarget")
...
//
// Solidity: function verifySequenceTimeTarget() view returns(uint64)
func (_Polygonrollupmanager *PolygonrollupmanagerSession) VerifySequenceTimeTarget() (uint64, error) {
	return _Polygonrollupmanager.Contract.VerifySequenceTimeTarget(&_Polygonrollupmanager.CallOpts)
}

// VerifySequenceTimeTarget is a free data retrieval call binding the contract method 0xb7397536.
//
// Solidity: function verifySequenceTimeTarget() view returns(uint64)
func (_Polygonrollupmanager *PolygonrollupmanagerCallerSession) VerifySequenceTimeTarget() (uint64, error) {
	return _Polygonrollupmanager.Contract.VerifySequenceTimeTarget(&_Polygonrollupmanager.CallOpts)
}
...
func (_Polygonrollupmanager *PolygonrollupmanagerTransactor) OnSequence(opts *bind.TransactOpts, zkGasLimitSequenced *big.Int, blobsSequenced uint64, newAccInputHash [32]byte) (*types.Transaction, error) {
	return _Polygonrollupmanager.contract.Transact(opts, "onSequence", zkGasLimitSequenced, blobsSequenced, newAccInputHash)
}

// OnSequence is a paid mutator transaction binding the contract method 0xfe01d89e.
//
// Solidity: function onSequence(uint128 zkGasLimitSequenced, uint64 blobsSequenced, bytes32 newAccInputHash) returns(uint64)
func (_Polygonrollupmanager *PolygonrollupmanagerSession) OnSequence(zkGasLimitSequenced *big.Int, blobsSequenced uint64, newAccInputHash [32]byte) (*types.Transaction, error) {
	return _Polygonrollupmanager.Contract.OnSequence(&_Polygonrollupmanager.TransactOpts, zkGasLimitSequenced, blobsSequenced, newAccInputHash)
}

// OnSequence is a paid mutator transaction binding the contract method 0xfe01d89e.
//
// Solidity: function onSequence(uint128 zkGasLimitSequenced, uint64 blobsSequenced, bytes32 newAccInputHash) returns(uint64)
func (_Polygonrollupmanager *PolygonrollupmanagerTransactorSession) OnSequence(zkGasLimitSequenced *big.Int, blobsSequenced uint64, newAccInputHash [32]byte) (*types.Transaction, error) {
	return _Polygonrollupmanager.Contract.OnSequence(&_Polygonrollupmanager.TransactOpts, zkGasLimitSequenced, blobsSequenced, newAccInputHash)
}
...
func (_Polygonrollupmanager *PolygonrollupmanagerTransactor) OverridePendingState(opts *bind.TransactOpts, rollupID uint32, initPendingStateNum uint64, finalPendingStateNum uint64, initSequenceNum uint64, finalSequenceNum uint64, newLocalExitRoot [32]byte, newStateRoot [32]byte, proof [24][32]byte) (*types.Transaction, error) {
	return _Polygonrollupmanager.contract.Transact(opts, "overridePendingState", rollupID, initPendingStateNum, finalPendingStateNum, initSequenceNum, finalSequenceNum, newLocalExitRoot, newStateRoot, proof)
}

// OverridePendingState is a paid mutator transaction binding the contract method 0x12b86e19.
//
// Solidity: function overridePendingState(uint32 rollupID, uint64 initPendingStateNum, uint64 finalPendingStateNum, uint64 initSequenceNum, uint64 finalSequenceNum, bytes32 newLocalExitRoot, bytes32 newStateRoot, bytes32[24] proof) returns()
func (_Polygonrollupmanager *PolygonrollupmanagerSession) OverridePendingState(rollupID uint32, initPendingStateNum uint64, finalPendingStateNum uint64, initSequenceNum uint64, finalSequenceNum uint64, newLocalExitRoot [32]byte, newStateRoot [32]byte, proof [24][32]byte) (*types.Transaction, error) {
	return _Polygonrollupmanager.Contract.OverridePendingState(&_Polygonrollupmanager.TransactOpts, rollupID, initPendingStateNum, finalPendingStateNum, initSequenceNum, finalSequenceNum, newLocalExitRoot, newStateRoot, proof)
}

// OverridePendingState is a paid mutator transaction binding the contract method 0x12b86e19.
//
// Solidity: function overridePendingState(uint32 rollupID, uint64 initPendingStateNum, uint64 finalPendingStateNum, uint64 initSequenceNum, uint64 finalSequenceNum, bytes32 newLocalExitRoot, bytes32 newStateRoot, bytes32[24] proof) returns()
func (_Polygonrollupmanager *PolygonrollupmanagerTransactorSession) OverridePendingState(rollupID uint32, initPendingStateNum uint64, finalPendingStateNum uint64, initSequenceNum uint64, finalSequenceNum uint64, newLocalExitRoot [32]byte, newStateRoot [32]byte, proof [24][32]byte) (*types.Transaction, error) {
	return _Polygonrollupmanager.Contract.OverridePendingState(&_Polygonrollupmanager.TransactOpts, rollupID, initPendingStateNum, finalPendingStateNum, initSequenceNum, finalSequenceNum, newLocalExitRoot, newStateRoot, proof)
}
...
func (_Polygonrollupmanager *PolygonrollupmanagerTransactor) ProveNonDeterministicPendingState(opts *bind.TransactOpts, rollupID uint32, initPendingStateNum uint64, finalPendingStateNum uint64, initSequenceNum uint64, finalSequenceNum uint64, newLocalExitRoot [32]byte, newStateRoot [32]byte, proof [24][32]byte) (*types.Transaction, error) {
	return _Polygonrollupmanager.contract.Transact(opts, "proveNonDeterministicPendingState", rollupID, initPendingStateNum, finalPendingStateNum, initSequenceNum, finalSequenceNum, newLocalExitRoot, newStateRoot, proof)
}

// ProveNonDeterministicPendingState is a paid mutator transaction binding the contract method 0x8bd4f071.
//
// Solidity: function proveNonDeterministicPendingState(uint32 rollupID, uint64 initPendingStateNum, uint64 finalPendingStateNum, uint64 initSequenceNum, uint64 finalSequenceNum, bytes32 newLocalExitRoot, bytes32 newStateRoot, bytes32[24] proof) returns()
func (_Polygonrollupmanager *PolygonrollupmanagerSession) ProveNonDeterministicPendingState(rollupID uint32, initPendingStateNum uint64, finalPendingStateNum uint64, initSequenceNum uint64, finalSequenceNum uint64, newLocalExitRoot [32]byte, newStateRoot [32]byte, proof [24][32]byte) (*types.Transaction, error) {
	return _Polygonrollupmanager.Contract.ProveNonDeterministicPendingState(&_Polygonrollupmanager.TransactOpts, rollupID, initPendingStateNum, finalPendingStateNum, initSequenceNum, finalSequenceNum, newLocalExitRoot, newStateRoot, proof)
}

// ProveNonDeterministicPendingState is a paid mutator transaction binding the contract method 0x8bd4f071.
//
// Solidity: function proveNonDeterministicPendingState(uint32 rollupID, uint64 initPendingStateNum, uint64 finalPendingStateNum, uint64 initSequenceNum, uint64 finalSequenceNum, bytes32 newLocalExitRoot, bytes32 newStateRoot, bytes32[24] proof) returns()
func (_Polygonrollupmanager *PolygonrollupmanagerTransactorSession) ProveNonDeterministicPendingState(rollupID uint32, initPendingStateNum uint64, finalPendingStateNum uint64, initSequenceNum uint64, finalSequenceNum uint64, newLocalExitRoot [32]byte, newStateRoot [32]byte, proof [24][32]byte) (*types.Transaction, error) {
	return _Polygonrollupmanager.Contract.ProveNonDeterministicPendingState(&_Polygonrollupmanager.TransactOpts, rollupID, initPendingStateNum, finalPendingStateNum, initSequenceNum, finalSequenceNum, newLocalExitRoot, newStateRoot, proof)
}
...
func (_Polygonrollupmanager *PolygonrollupmanagerTransactor) SetAggregateRollupVerifier(opts *bind.TransactOpts, newAggregateRollupVerifier common.Address) (*types.Transaction, error) {
	return _Polygonrollupmanager.contract.Transact(opts, "setAggregateRollupVerifier", newAggregateRollupVerifier)
}

// SetAggregateRollupVerifier is a paid mutator transaction binding the contract method 0xe2bfe8b3.
//
// Solidity: function setAggregateRollupVerifier(address newAggregateRollupVerifier) returns()
func (_Polygonrollupmanager *PolygonrollupmanagerSession) SetAggregateRollupVerifier(newAggregateRollupVerifier common.Address) (*types.Transaction, error) {
	return _Polygonrollupmanager.Contract.SetAggregateRollupVerifier(&_Polygonrollupmanager.TransactOpts, newAggregateRollupVerifier)
}

// SetAggregateRollupVerifier is a paid mutator transaction binding the contract method 0xe2bfe8b3.
//
// Solidity: function setAggregateRollupVerifier(address newAggregateRollupVerifier) returns()
func (_Polygonrollupmanager *PolygonrollupmanagerTransactorSession) SetAggregateRollupVerifier(newAggregateRollupVerifier common.Address) (*types.Transaction, error) {
	return _Polygonrollupmanager.Contract.SetAggregateRollupVerifier(&_Polygonrollupmanager.TransactOpts, newAggregateRollupVerifier)
}
...
func (_Polygonrollupmanager *PolygonrollupmanagerTransactor) SetMultiplierZkGasPrice(opts *bind.TransactOpts, newMultiplierZkGasPrice uint16) (*types.Transaction, error) {
	return _Polygonrollupmanager.contract.Transact(opts, "setMultiplierZkGasPrice", newMultiplierZkGasPrice)
}

// SetMultiplierZkGasPrice is a paid mutator transaction binding the contract method 0xa1094df3.
//
// Solidity: function setMultiplierZkGasPrice(uint16 newMultiplierZkGasPrice) returns()
func (_Polygonrollupmanager *PolygonrollupmanagerSession) SetMultiplierZkGasPrice(newMultiplierZkGasPrice uint16) (*types.Transaction, error) {
	return _Polygonrollupmanager.Contract.SetMultiplierZkGasPrice(&_Polygonrollupmanager.TransactOpts, newMultiplierZkGasPrice)
}

// SetMultiplierZkGasPrice is a paid mutator transaction binding the contract method 0xa1094df3.
//
// Solidity: function setMultiplierZkGasPrice(uint16 newMultiplierZkGasPrice) returns()
func (_Polygonrollupmanager *PolygonrollupmanagerTransactorSession) SetMultiplierZkGasPrice(newMultiplierZkGasPrice uint16) (*types.Transaction, error) {
	return _Polygonrollupmanager.Contract.SetMultiplierZkGasPrice(&_Polygonrollupmanager.TransactOpts, newMultiplierZkGasPrice)
}
...
func (_Polygonrollupmanager *PolygonrollupmanagerTransactor) SetVerifySequenceTimeTarget(opts *bind.TransactOpts, newVerifySequenceTimeTarget uint64) (*types.Transaction, error) {
	return _Polygonrollupmanager.contract.Transact(opts, "setVerifySequenceTimeTarget", newVerifySequenceTimeTarget)
}

// SetVerifySequenceTimeTarget is a paid mutator transaction binding the contract method 0x8185f9d3.
//
// Solidity: function setVerifySequenceTimeTarget(uint64 newVerifySequenceTimeTarget) returns()
func (_Polygonrollupmanager *PolygonrollupmanagerSession) SetVerifySequenceTimeTarget(newVerifySequenceTimeTarget uint64) (*types.Transaction, error) {
	return _Polygonrollupmanager.Contract.SetVerifySequenceTimeTarget(&_Polygonrollupmanager.TransactOpts, newVerifySequenceTimeTarget)
}

// SetVerifySequenceTimeTarget is a paid mutator transaction binding the contract method 0x8185f9d3.
//
// Solidity: function setVerifySequenceTimeTarget(uint64 newVerifySequenceTimeTarget) returns()
func (_Polygonrollupmanager *PolygonrollupmanagerTransactorSession) SetVerifySequenceTimeTarget(newVerifySequenceTimeTarget uint64) (*types.Transaction, error) {
	return _Polygonrollupmanager.Contract.SetVerifySequenceTimeTarget(&_Polygonrollupmanager.TransactOpts, newVerifySequenceTimeTarget)
}
...
func (_Polygonrollupmanager *PolygonrollupmanagerTransactor) SetZkGasPrice(opts *bind.TransactOpts, newZkGasPrice *big.Int) (*types.Transaction, error) {
	return _Polygonrollupmanager.contract.Transact(opts, "setZkGasPrice", newZkGasPrice)
}

// SetZkGasPrice is a paid mutator transaction binding the contract method 0x7ec31def.
//
// Solidity: function setZkGasPrice(uint256 newZkGasPrice) returns()
func (_Polygonrollupmanager *PolygonrollupmanagerSession) SetZkGasPrice(newZkGasPrice *big.Int) (*types.Transaction, error) {
	return _Polygonrollupmanager.Contract.SetZkGasPrice(&_Polygonrollupmanager.TransactOpts, newZkGasPrice)
}

// SetZkGasPrice is a paid mutator transaction binding the contract method 0x7ec31def.
//
// Solidity: function setZkGasPrice(uint256 newZkGasPrice) returns()
func (_Polygonrollupmanager *PolygonrollupmanagerTransactorSession) SetZkGasPrice(newZkGasPrice *big.Int) (*types.Transaction, error) {
	return _Polygonrollupmanager.Contract.SetZkGasPrice(&_Polygonrollupmanager.TransactOpts, newZkGasPrice)
}
...
func (_Polygonrollupmanager *PolygonrollupmanagerTransactor) VerifySequencesMultiProof(opts *bind.TransactOpts, verifySequencesData []PolygonRollupManagerVerifySequenceData, beneficiary common.Address, proof [24][32]byte) (*types.Transaction, error) {
	return _Polygonrollupmanager.contract.Transact(opts, "verifySequencesMultiProof", verifySequencesData, beneficiary, proof)
}

// VerifySequencesMultiProof is a paid mutator transaction binding the contract method 0xf00bdaa4.
//
// Solidity: function verifySequencesMultiProof((uint32,uint64,uint64,uint64,bytes32,bytes32)[] verifySequencesData, address beneficiary, bytes32[24] proof) returns()
func (_Polygonrollupmanager *PolygonrollupmanagerSession) VerifySequencesMultiProof(verifySequencesData []PolygonRollupManagerVerifySequenceData, beneficiary common.Address, proof [24][32]byte) (*types.Transaction, error) {
	return _Polygonrollupmanager.Contract.VerifySequencesMultiProof(&_Polygonrollupmanager.TransactOpts, verifySequencesData, beneficiary, proof)
}

// VerifySequencesMultiProof is a paid mutator transaction binding the contract method 0xf00bdaa4.
//
// Solidity: function verifySequencesMultiProof((uint32,uint64,uint64,uint64,bytes32,bytes32)[] verifySequencesData, address beneficiary, bytes32[24] proof) returns()
func (_Polygonrollupmanager *PolygonrollupmanagerTransactorSession) VerifySequencesMultiProof(verifySequencesData []PolygonRollupManagerVerifySequenceData, beneficiary common.Address, proof [24][32]byte) (*types.Transaction, error) {
	return _Polygonrollupmanager.Contract.VerifySequencesMultiProof(&_Polygonrollupmanager.TransactOpts, verifySequencesData, beneficiary, proof)
}
...
func (_Polygonrollupmanager *PolygonrollupmanagerTransactor) VerifySequencesTrustedAggregatorMultiProof(opts *bind.TransactOpts, verifySequencesData []PolygonRollupManagerVerifySequenceData, beneficiary common.Address, proof [24][32]byte) (*types.Transaction, error) {
	return _Polygonrollupmanager.contract.Transact(opts, "verifySequencesTrustedAggregatorMultiProof", verifySequencesData, beneficiary, proof)
}

// VerifySequencesTrustedAggregatorMultiProof is a paid mutator transaction binding the contract method 0xde794850.
//
// Solidity: function verifySequencesTrustedAggregatorMultiProof((uint32,uint64,uint64,uint64,bytes32,bytes32)[] verifySequencesData, address beneficiary, bytes32[24] proof) returns()
func (_Polygonrollupmanager *PolygonrollupmanagerSession) VerifySequencesTrustedAggregatorMultiProof(verifySequencesData []PolygonRollupManagerVerifySequenceData, beneficiary common.Address, proof [24][32]byte) (*types.Transaction, error) {
	return _Polygonrollupmanager.Contract.VerifySequencesTrustedAggregatorMultiProof(&_Polygonrollupmanager.TransactOpts, verifySequencesData, beneficiary, proof)
}

// VerifySequencesTrustedAggregatorMultiProof is a paid mutator transaction binding the contract method 0xde794850.
//
// Solidity: function verifySequencesTrustedAggregatorMultiProof((uint32,uint64,uint64,uint64,bytes32,bytes32)[] verifySequencesData, address beneficiary, bytes32[24] proof) returns()
func (_Polygonrollupmanager *PolygonrollupmanagerTransactorSession) VerifySequencesTrustedAggregatorMultiProof(verifySequencesData []PolygonRollupManagerVerifySequenceData, beneficiary common.Address, proof [24][32]byte) (*types.Transaction, error) {
	return _Polygonrollupmanager.Contract.VerifySequencesTrustedAggregatorMultiProof(&_Polygonrollupmanager.TransactOpts, verifySequencesData, beneficiary, proof)
}
...
// PolygonrollupmanagerOnSequenceIterator is returned from FilterOnSequence and is used to iterate over the raw logs and unpacked data for OnSequence events raised by the Polygonrollupmanager contract.
type PolygonrollupmanagerOnSequenceIterator struct {
	Event *PolygonrollupmanagerOnSequence // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *PolygonrollupmanagerOnSequenceIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(PolygonrollupmanagerOnSequence)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *PolygonrollupmanagerOnSequenceIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *PolygonrollupmanagerOnSequenceIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// PolygonrollupmanagerOnSequence represents a OnSequence event raised by the Polygonrollupmanager contract.
type PolygonrollupmanagerOnSequence struct {
	RollupID       uint32
	ZkGasLimit     *big.Int
...
func (_Polygonrollupmanager *PolygonrollupmanagerFilterer) FilterOnSequence(opts *bind.FilterOpts, rollupID []uint32) (*PolygonrollupmanagerOnSequenceIterator, error) {
	...
	logs, sub, err := _Polygonrollupmanager.contract.FilterLogs(opts, "OnSequence", rollupIDRule)
	if err != nil {
		return nil, err
	}
	return &PolygonrollupmanagerOnSequenceIterator{contract: _Polygonrollupmanager.contract, event: "OnSequence", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event OnSequence(uint32 indexed rollupID, uint128 zkGasLimit, uint64 blobsSequenced)
func (_Polygonrollupmanager *PolygonrollupmanagerFilterer) WatchOnSequence(opts *bind.WatchOpts, sink chan<- *PolygonrollupmanagerOnSequence, rollupID []uint32) (event.Subscription, error) {
	...
	logs, sub, err := _Polygonrollupmanager.contract.WatchLogs(opts, "OnSequence", rollupIDRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(PolygonrollupmanagerOnSequence)
				if err := _Polygonrollupmanager.contract.UnpackLog(event, "OnSequence", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event OnSequence(uint32 indexed rollupID, uint128 zkGasLimit, uint64 blobsSequenced)
func (_Polygonrollupmanager *PolygonrollupmanagerFilterer) ParseOnSequence(log types.Log) (*PolygonrollupmanagerOnSequence, error) {
	event := new(PolygonrollupmanagerOnSequence)
	if err := _Polygonrollupmanager.contract.UnpackLog(event, "OnSequence", log); err != nil {
		return nil, err
	}
...
// PolygonrollupmanagerSetAggregateRollupVerifierIterator is returned from FilterSetAggregateRollupVerifier and is used to iterate over the raw logs and unpacked data for SetAggregateRollupVerifier events raised by the Polygonrollupmanager contract.
type PolygonrollupmanagerSetAggregateRollupVerifierIterator struct {
	Event *PolygonrollupmanagerSetAggregateRollupVerifier // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *PolygonrollupmanagerSetAggregateRollupVerifierIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(PolygonrollupmanagerSetAggregateRollupVerifier)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *PolygonrollupmanagerSetAggregateRollupVerifierIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *PolygonrollupmanagerSetAggregateRollupVerifierIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// PolygonrollupmanagerSetAggregateRollupVerifier represents a SetAggregateRollupVerifier event raised by the Polygonrollupmanager contract.
type PolygonrollupmanagerSetAggregateRollupVerifier struct {
...
func (_Polygonrollupmanager *PolygonrollupmanagerFilterer) FilterSetAggregateRollupVerifier(opts *bind.FilterOpts) (*PolygonrollupmanagerSetAggregateRollupVerifierIterator, error) {

	logs, sub, err := _Polygonrollupmanager.contract.FilterLogs(opts, "SetAggregateRollupVerifier")
	if err != nil {
		return nil, err
	}
	return &PolygonrollupmanagerSetAggregateRollupVerifierIterator{contract: _Polygonrollupmanager.contract, event: "SetAggregateRollupVerifier", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event SetAggregateRollupVerifier(address aggregateRollupVerifier)
func (_Polygonrollupmanager *PolygonrollupmanagerFilterer) WatchSetAggregateRollupVerifier(opts *bind.WatchOpts, sink chan<- *PolygonrollupmanagerSetAggregateRollupVerifier) (event.Subscription, error) {

	logs, sub, err := _Polygonrollupmanager.contract.WatchLogs(opts, "SetAggregateRollupVerifier")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(PolygonrollupmanagerSetAggregateRollupVerifier)
				if err := _Polygonrollupmanager.contract.UnpackLog(event, "SetAggregateRollupVerifier", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event SetAggregateRollupVerifier(address aggregateRollupVerifier)
func (_Polygonrollupmanager *PolygonrollupmanagerFilterer) ParseSetAggregateRollupVerifier(log types.Log) (*PolygonrollupmanagerSetAggregateRollupVerifier, error) {
	event := new(PolygonrollupmanagerSetAggregateRollupVerifier)
	if err := _Polygonrollupmanager.contract.UnpackLog(event, "SetAggregateRollupVerifier", log); err != nil {
		return nil, err
	}
...
// PolygonrollupmanagerSetMultiplierZkGasPriceIterator is returned from FilterSetMultiplierZkGasPrice and is used to iterate over the raw logs and unpacked data for SetMultiplierZkGasPrice events raised by the Polygonrollupmanager contract.
type PolygonrollupmanagerSetMultiplierZkGasPriceIterator struct {
	Event *PolygonrollupmanagerSetMultiplierZkGasPrice // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *PolygonrollupmanagerSetMultiplierZkGasPriceIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(PolygonrollupmanagerSetMultiplierZkGasPrice)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *PolygonrollupmanagerSetMultiplierZkGasPriceIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *PolygonrollupmanagerSetMultiplierZkGasPriceIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// PolygonrollupmanagerSetMultiplierZkGasPrice represents a SetMultiplierZkGasPrice event raised by the Polygonrollupmanager contract.
type PolygonrollupmanagerSetMultiplierZkGasPrice struct {
...
func (_Polygonrollupmanager *PolygonrollupmanagerFilterer) FilterSetMultiplierZkGasPrice(opts *bind.FilterOpts) (*PolygonrollupmanagerSetMultiplierZkGasPriceIterator, error) {

	logs, sub, err := _Polygonrollupmanager.contract.FilterLogs(opts, "SetMultiplierZkGasPrice")
	if err != nil {
		return nil, err
	}
	return &PolygonrollupmanagerSetMultiplierZkGasPriceIterator{contract: _Polygonrollupmanager.contract, event: "SetMultiplierZkGasPrice", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event SetMultiplierZkGasPrice(uint16 newMultiplierSequenceFee)
func (_Polygonrollupmanager *PolygonrollupmanagerFilterer) WatchSetMultiplierZkGasPrice(opts *bind.WatchOpts, sink chan<- *PolygonrollupmanagerSetMultiplierZkGasPrice) (event.Subscription, error) {

	logs, sub, err := _Polygonrollupmanager.contract.WatchLogs(opts, "SetMultiplierZkGasPrice")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(PolygonrollupmanagerSetMultiplierZkGasPrice)
				if err := _Polygonrollupmanager.contract.UnpackLog(event, "SetMultiplierZkGasPrice", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event SetMultiplierZkGasPrice(uint16 newMultiplierSequenceFee)
func (_Polygonrollupmanager *PolygonrollupmanagerFilterer) ParseSetMultiplierZkGasPrice(log types.Log) (*PolygonrollupmanagerSetMultiplierZkGasPrice, error) {
	event := new(PolygonrollupmanagerSetMultiplierZkGasPrice)
	if err := _Polygonrollupmanager.contract.UnpackLog(event, "SetMultiplierZkGasPrice", log); err != nil {
		return nil, err
	}
...
// PolygonrollupmanagerSetSequenceFeeIterator is returned from FilterSetSequenceFee and is used to iterate over the raw logs and unpacked data for SetSequenceFee events raised by the Polygonrollupmanager contract.
type PolygonrollupmanagerSetSequenceFeeIterator struct {
	Event *PolygonrollupmanagerSetSequenceFee // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *PolygonrollupmanagerSetSequenceFeeIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(PolygonrollupmanagerSetSequenceFee)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *PolygonrollupmanagerSetSequenceFeeIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *PolygonrollupmanagerSetSequenceFeeIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// PolygonrollupmanagerSetSequenceFee represents a SetSequenceFee event raised by the Polygonrollupmanager contract.
type PolygonrollupmanagerSetSequenceFee struct {
...
func (_Polygonrollupmanager *PolygonrollupmanagerFilterer) FilterSetSequenceFee(opts *bind.FilterOpts) (*PolygonrollupmanagerSetSequenceFeeIterator, error) {

	logs, sub, err := _Polygonrollupmanager.contract.FilterLogs(opts, "SetSequenceFee")
	if err != nil {
		return nil, err
	}
	return &PolygonrollupmanagerSetSequenceFeeIterator{contract: _Polygonrollupmanager.contract, event: "SetSequenceFee", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event SetSequenceFee(uint256 newSequenceFee)
func (_Polygonrollupmanager *PolygonrollupmanagerFilterer) WatchSetSequenceFee(opts *bind.WatchOpts, sink chan<- *PolygonrollupmanagerSetSequenceFee) (event.Subscription, error) {

	logs, sub, err := _Polygonrollupmanager.contract.WatchLogs(opts, "SetSequenceFee")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(PolygonrollupmanagerSetSequenceFee)
				if err := _Polygonrollupmanager.contract.UnpackLog(event, "SetSequenceFee", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event SetSequenceFee(uint256 newSequenceFee)
func (_Polygonrollupmanager *PolygonrollupmanagerFilterer) ParseSetSequenceFee(log types.Log) (*PolygonrollupmanagerSetSequenceFee, error) {
	event := new(PolygonrollupmanagerSetSequenceFee)
	if err := _Polygonrollupmanager.contract.UnpackLog(event, "SetSequenceFee", log); err != nil {
		return nil, err
	}
...
// PolygonrollupmanagerSetVerifySequenceTimeTargetIterator is returned from FilterSetVerifySequenceTimeTarget and is used to iterate over the raw logs and unpacked data for SetVerifySequenceTimeTarget events raised by the Polygonrollupmanager contract.
type PolygonrollupmanagerSetVerifySequenceTimeTargetIterator struct {
	Event *PolygonrollupmanagerSetVerifySequenceTimeTarget // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *PolygonrollupmanagerSetVerifySequenceTimeTargetIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(PolygonrollupmanagerSetVerifySequenceTimeTarget)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *PolygonrollupmanagerSetVerifySequenceTimeTargetIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *PolygonrollupmanagerSetVerifySequenceTimeTargetIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// PolygonrollupmanagerSetVerifySequenceTimeTarget represents a SetVerifySequenceTimeTarget event raised by the Polygonrollupmanager contract.
type PolygonrollupmanagerSetVerifySequenceTimeTarget struct {
...
func (_Polygonrollupmanager *PolygonrollupmanagerFilterer) FilterSetVerifySequenceTimeTarget(opts *bind.FilterOpts) (*PolygonrollupmanagerSetVerifySequenceTimeTargetIterator, error) {

	logs, sub, err := _Polygonrollupmanager.contract.FilterLogs(opts, "SetVerifySequenceTimeTarget")
	if err != nil {
		return nil, err
	}
	return &PolygonrollupmanagerSetVerifySequenceTimeTargetIterator{contract: _Polygonrollupmanager.contract, event: "SetVerifySequenceTimeTarget", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event SetVerifySequenceTimeTarget(uint64 newVerifySequenceTimeTarget)
func (_Polygonrollupmanager *PolygonrollupmanagerFilterer) WatchSetVerifySequenceTimeTarget(opts *bind.WatchOpts, sink chan<- *PolygonrollupmanagerSetVerifySequenceTimeTarget) (event.Subscription, error) {

	logs, sub, err := _Polygonrollupmanager.contract.WatchLogs(opts, "SetVerifySequenceTimeTarget")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(PolygonrollupmanagerSetVerifySequenceTimeTarget)
				if err := _Polygonrollupmanager.contract.UnpackLog(event, "SetVerifySequenceTimeTarget", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event SetVerifySequenceTimeTarget(uint64 newVerifySequenceTimeTarget)
func (_Polygonrollupmanager *PolygonrollupmanagerFilterer) ParseSetVerifySequenceTimeTarget(log types.Log) (*PolygonrollupmanagerSetVerifySequenceTimeTarget, error) {
	event := new(PolygonrollupmanagerSetVerifySequenceTimeTarget)
	if err := _Polygonrollupmanager.contract.UnpackLog(event, "SetVerifySequenceTimeTarget", log); err != nil {
		return nil, err
	}
...
// PolygonrollupmanagerVerifySequencesIterator is returned from FilterVerifySequences and is used to iterate over the raw logs and unpacked data for VerifySequences events raised by the Polygonrollupmanager contract.
type PolygonrollupmanagerVerifySequencesIterator struct {
	Event *PolygonrollupmanagerVerifySequences // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *PolygonrollupmanagerVerifySequencesIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(PolygonrollupmanagerVerifySequences)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *PolygonrollupmanagerVerifySequencesIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *PolygonrollupmanagerVerifySequencesIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// PolygonrollupmanagerVerifySequences represents a VerifySequences event raised by the Polygonrollupmanager contract.
type PolygonrollupmanagerVerifySequences struct {
	RollupID    uint32
	SequenceNum uint64
	StateRoot   [32]byte
	ExitRoot    [32]byte
...
func (_Polygonrollupmanager *PolygonrollupmanagerFilterer) FilterVerifySequences(opts *bind.FilterOpts, rollupID []uint32, aggregator []common.Address) (*PolygonrollupmanagerVerifySequencesIterator, error) {
	...
	logs, sub, err := _Polygonrollupmanager.contract.FilterLogs(opts, "VerifySequences", rollupIDRule, aggregatorRule)
	if err != nil {
		return nil, err
	}
	return &PolygonrollupmanagerVerifySequencesIterator{contract: _Polygonrollupmanager.contract, event: "VerifySequences", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event VerifySequences(uint32 indexed rollupID, uint64 sequenceNum, bytes32 stateRoot, bytes32 exitRoot, address indexed aggregator)
func (_Polygonrollupmanager *PolygonrollupmanagerFilterer) WatchVerifySequences(opts *bind.WatchOpts, sink chan<- *PolygonrollupmanagerVerifySequences, rollupID []uint32, aggregator []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Polygonrollupmanager.contract.WatchLogs(opts, "VerifySequences", rollupIDRule, aggregatorRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(PolygonrollupmanagerVerifySequences)
				if err := _Polygonrollupmanager.contract.UnpackLog(event, "VerifySequences", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event VerifySequences(uint32 indexed rollupID, uint64 sequenceNum, bytes32 stateRoot, bytes32 exitRoot, address indexed aggregator)
func (_Polygonrollupmanager *PolygonrollupmanagerFilterer) ParseVerifySequences(log types.Log) (*PolygonrollupmanagerVerifySequences, error) {
	event := new(PolygonrollupmanagerVerifySequences)
	if err := _Polygonrollupmanager.contract.UnpackLog(event, "VerifySequences", log); err != nil {
		return nil, err
	}
...
// PolygonrollupmanagerVerifySequencesMultiProofIterator is returned from FilterVerifySequencesMultiProof and is used to iterate over the raw logs and unpacked data for VerifySequencesMultiProof events raised by the Polygonrollupmanager contract.
type PolygonrollupmanagerVerifySequencesMultiProofIterator struct {
	Event *PolygonrollupmanagerVerifySequencesMultiProof // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *PolygonrollupmanagerVerifySequencesMultiProofIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(PolygonrollupmanagerVerifySequencesMultiProof)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *PolygonrollupmanagerVerifySequencesMultiProofIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *PolygonrollupmanagerVerifySequencesMultiProofIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// PolygonrollupmanagerVerifySequencesMultiProof represents a VerifySequencesMultiProof event raised by the Polygonrollupmanager contract.
type PolygonrollupmanagerVerifySequencesMultiProof struct {
	Aggregator common.Address
	Raw        types.Log // Blockchain specific contextual infos
}
...
func (_Polygonrollupmanager *PolygonrollupmanagerFilterer) FilterVerifySequencesMultiProof(opts *bind.FilterOpts, aggregator []common.Address) (*PolygonrollupmanagerVerifySequencesMultiProofIterator, error) {
	...
	logs, sub, err := _Polygonrollupmanager.contract.FilterLogs(opts, "VerifySequencesMultiProof", aggregatorRule)
	if err != nil {
		return nil, err
	}
	return &PolygonrollupmanagerVerifySequencesMultiProofIterator{contract: _Polygonrollupmanager.contract, event: "VerifySequencesMultiProof", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event VerifySequencesMultiProof(address indexed aggregator)
func (_Polygonrollupmanager *PolygonrollupmanagerFilterer) WatchVerifySequencesMultiProof(opts *bind.WatchOpts, sink chan<- *PolygonrollupmanagerVerifySequencesMultiProof, aggregator []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Polygonrollupmanager.contract.WatchLogs(opts, "VerifySequencesMultiProof", aggregatorRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(PolygonrollupmanagerVerifySequencesMultiProof)
				if err := _Polygonrollupmanager.contract.UnpackLog(event, "VerifySequencesMultiProof", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event VerifySequencesMultiProof(address indexed aggregator)
func (_Polygonrollupmanager *PolygonrollupmanagerFilterer) ParseVerifySequencesMultiProof(log types.Log) (*PolygonrollupmanagerVerifySequencesMultiProof, error) {
	event := new(PolygonrollupmanagerVerifySequencesMultiProof)
	if err := _Polygonrollupmanager.contract.UnpackLog(event, "VerifySequencesMultiProof", log); err != nil {
		return nil, err
	}
...
// PolygonrollupmanagerVerifySequencesTrustedAggregatorIterator is returned from FilterVerifySequencesTrustedAggregator and is used to iterate over the raw logs and unpacked data for VerifySequencesTrustedAggregator events raised by the Polygonrollupmanager contract.
type PolygonrollupmanagerVerifySequencesTrustedAggregatorIterator struct {
	Event *PolygonrollupmanagerVerifySequencesTrustedAggregator // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *PolygonrollupmanagerVerifySequencesTrustedAggregatorIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(PolygonrollupmanagerVerifySequencesTrustedAggregator)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *PolygonrollupmanagerVerifySequencesTrustedAggregatorIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *PolygonrollupmanagerVerifySequencesTrustedAggregatorIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// PolygonrollupmanagerVerifySequencesTrustedAggregator represents a VerifySequencesTrustedAggregator event raised by the Polygonrollupmanager contract.
type PolygonrollupmanagerVerifySequencesTrustedAggregator struct {
	RollupID    uint32
	NumSequence uint64
	StateRoot   [32]byte
	ExitRoot    [32]byte
...
func (_Polygonrollupmanager *PolygonrollupmanagerFilterer) FilterVerifySequencesTrustedAggregator(opts *bind.FilterOpts, rollupID []uint32, aggregator []common.Address) (*PolygonrollupmanagerVerifySequencesTrustedAggregatorIterator, error) {
	...
	logs, sub, err := _Polygonrollupmanager.contract.FilterLogs(opts, "VerifySequencesTrustedAggregator", rollupIDRule, aggregatorRule)
	if err != nil {
		return nil, err
	}
	return &PolygonrollupmanagerVerifySequencesTrustedAggregatorIterator{contract: _Polygonrollupmanager.contract, event: "VerifySequencesTrustedAggregator", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event VerifySequencesTrustedAggregator(uint32 indexed rollupID, uint64 numSequence, bytes32 stateRoot, bytes32 exitRoot, address indexed aggregator)
func (_Polygonrollupmanager *PolygonrollupmanagerFilterer) WatchVerifySequencesTrustedAggregator(opts *bind.WatchOpts, sink chan<- *PolygonrollupmanagerVerifySequencesTrustedAggregator, rollupID []uint32, aggregator []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Polygonrollupmanager.contract.WatchLogs(opts, "VerifySequencesTrustedAggregator", rollupIDRule, aggregatorRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(PolygonrollupmanagerVerifySequencesTrustedAggregator)
				if err := _Polygonrollupmanager.contract.UnpackLog(event, "VerifySequencesTrustedAggregator", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event VerifySequencesTrustedAggregator(uint32 indexed rollupID, uint64 numSequence, bytes32 stateRoot, bytes32 exitRoot, address indexed aggregator)
func (_Polygonrollupmanager *PolygonrollupmanagerFilterer) ParseVerifySequencesTrustedAggregator(log types.Log) (*PolygonrollupmanagerVerifySequencesTrustedAggregator, error) {
	event := new(PolygonrollupmanagerVerifySequencesTrustedAggregator)
	if err := _Polygonrollupmanager.contract.UnpackLog(event, "VerifySequencesTrustedAggregator", log); err != nil {
		return nil, err
	}
...
// PolygonrollupmanagerVerifySequencesTrustedAggregatorMultiProofIterator is returned from FilterVerifySequencesTrustedAggregatorMultiProof and is used to iterate over the raw logs and unpacked data for VerifySequencesTrustedAggregatorMultiProof events raised by the Polygonrollupmanager contract.
type PolygonrollupmanagerVerifySequencesTrustedAggregatorMultiProofIterator struct {
	Event *PolygonrollupmanagerVerifySequencesTrustedAggregatorMultiProof // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *PolygonrollupmanagerVerifySequencesTrustedAggregatorMultiProofIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(PolygonrollupmanagerVerifySequencesTrustedAggregatorMultiProof)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *PolygonrollupmanagerVerifySequencesTrustedAggregatorMultiProofIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *PolygonrollupmanagerVerifySequencesTrustedAggregatorMultiProofIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// PolygonrollupmanagerVerifySequencesTrustedAggregatorMultiProof represents a VerifySequencesTrustedAggregatorMultiProof event raised by the Polygonrollupmanager contract.
type PolygonrollupmanagerVerifySequencesTrustedAggregatorMultiProof struct {
	Aggregator common.Address
	Raw        types.Log // Blockchain specific contextual infos
}
...
func (_Polygonrollupmanager *PolygonrollupmanagerFilterer) FilterVerifySequencesTrustedAggregatorMultiProof(opts *bind.FilterOpts, aggregator []common.Address) (*PolygonrollupmanagerVerifySequencesTrustedAggregatorMultiProofIterator, error) {
	...
	logs, sub, err := _Polygonrollupmanager.contract.FilterLogs(opts, "VerifySequencesTrustedAggregatorMultiProof", aggregatorRule)
	if err != nil {
		return nil, err
	}
	return &PolygonrollupmanagerVerifySequencesTrustedAggregatorMultiProofIterator{contract: _Polygonrollupmanager.contract, event: "VerifySequencesTrustedAggregatorMultiProof", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event VerifySequencesTrustedAggregatorMultiProof(address indexed aggregator)
func (_Polygonrollupmanager *PolygonrollupmanagerFilterer) WatchVerifySequencesTrustedAggregatorMultiProof(opts *bind.WatchOpts, sink chan<- *PolygonrollupmanagerVerifySequencesTrustedAggregatorMultiProof, aggregator []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Polygonrollupmanager.contract.WatchLogs(opts, "VerifySequencesTrustedAggregatorMultiProof", aggregatorRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(PolygonrollupmanagerVerifySequencesTrustedAggregatorMultiProof)
				if err := _Polygonrollupmanager.contract.UnpackLog(event, "VerifySequencesTrustedAggregatorMultiProof", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event VerifySequencesTrustedAggregatorMultiProof(address indexed aggregator)
func (_Polygonrollupmanager *PolygonrollupmanagerFilterer) ParseVerifySequencesTrustedAggregatorMultiProof(log types.Log) (*PolygonrollupmanagerVerifySequencesTrustedAggregatorMultiProof, error) {
	event := new(PolygonrollupmanagerVerifySequencesTrustedAggregatorMultiProof)
	if err := _Polygonrollupmanager.contract.UnpackLog(event, "VerifySequencesTrustedAggregatorMultiProof", log); err != nil {
		return nil, err
	}
